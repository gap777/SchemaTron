...
<script type="text/javascript">window.NREUM||(NREUM={});NREUM.info={"beacon":"beacon-3.newrelic.com","errorBeacon":"jserror.newrelic.com","licenseKey":"9dfe439095","applicationID":"8763","transactionName":"Il9dRhNbCVtVQhgXQgBTVkFOWgpTVUMYF1oORw==","queueTime":4,"applicationTime":2195,"ttGuid":"","agentToken":null,"agent":"js-agent.newrelic.com/nr-292.min.js","extra":""}</script>
<script type="text/javascript">window.NREUM||(NREUM={}),__nr_require=function a(b,c,d){function e(f){if(!c[f]){var g=c[f]={exports:{}};b[f][0].call(g.exports,function(a){var c=b[f][1][a];return e(c?c:a)},g,g.exports,a,b,c,d)}return c[f].exports}for(var f=0;f<d.length;f++)e(d[f]);return e}({"4O2Y62":[function(a,b){function c(a,b){var c=d[a];return c?c.apply(this,b):(e[a]||(e[a]=[]),void e[a].push(b))}var d={},e={};b.exports=c,c.queues=e,c.handlers=d},{}],handle:[function(a,b){b.exports=a("4O2Y62")},{}],"SvQ0B+":[function(a,b){function c(a){if(a===window)return 0;if(e.call(a,"__nr"))return a.__nr;try{return Object.defineProperty(a,"__nr",{value:d,writable:!1,configurable:!1,enumerable:!1}),d}catch(b){return a.__nr=d,d}finally{d+=1}}var d=1,e=Object.prototype.hasOwnProperty;b.exports=c},{}],id:[function(a,b){b.exports=a("SvQ0B+")},{}],YLUGVp:[function(a,b){function c(){var a=m.info=NREUM.info,b=m.proto="https"===l.split(":")[0]||a.sslForHttp?"https://":"http://";if(a&&a.agent&&a.licenseKey&&a.applicationID){f("mark",["onload",e()]);var c=h.createElement("script");c.src=b+a.agent,h.body.appendChild(c)}}function d(){"complete"===h.readyState&&f("mark",["domContent",e()])}function e(){return(new Date).getTime()}var f=a("handle"),g=window,h=g.document,i="readystatechange",j="addEventListener",k="attachEvent",l=(""+location).split("?")[0],m=b.exports={offset:e(),origin:l};h[j]?(h[j](i,d,!1),g[j]("load",c,!1)):(h[k]("on"+i,d),g[k]("onload",c)),f("mark",["firstbyte",e()])},{handle:"4O2Y62"}],loader:[function(a,b){b.exports=a("YLUGVp")},{}]},{},["YLUGVp"]);</script>
    <title>docs/build-docs.bat | Git | Assembla</title>
...
<div class="dropdown-menu w-400 ">
  ...
  <div class="s-tabs-container">
    ...
    <div class="dropdown-menu-list">
        <ul id="all" class="branches-list hidden active">
            ...
            <span>
              <li class="sg"><a href="/code/xrouter/git/nodes/1.0/docs/build-docs.bat?type=tag" class="branch-name-link sg-text pjax" data-dropdown-button-type-title="Tag" data-name-escaped="1.0" data-name="1.0" data-url="/code/xrouter/git/nodes/1.0/docs/build-docs.bat?type=tag">1.0</a></li>
            </span>
            <div class="no-results">No results</div>

          <h4 class="std-subheader">Branches</h4>
          <li class="sg"><a href="/code/xrouter/git/nodes/develop/docs/build-docs.bat" class="branch-name-link sg-text pjax" data-dropdown-button-type-title="Branch" data-name-escaped="develop" data-name="develop" data-url="/code/xrouter/git/nodes/develop/docs/build-docs.bat">develop</a></li><li class="sg"><a href="/code/xrouter/git/nodes/fix-57-solution-2/docs/build-docs.bat" class="branch-name-link sg-text pjax" data-dropdown-button-type-title="Branch" data-name-escaped="fix-57-solution-2" data-name="fix-57-solution-2" data-url="/code/xrouter/git/nodes/fix-57-solution-2/docs/build-docs.bat">fix-57-solution-2</a></li><li class="sg"><a href="/code/xrouter/git/nodes/master/docs/build-docs.bat" class="branch-name-link sg-text pjax" data-dropdown-button-type-title="Branch" data-name-escaped="master" data-name="master" data-url="/code/xrouter/git/nodes/master/docs/build-docs.bat">master</a></li><li class="sg"><a href="/code/xrouter/git/nodes/simplification-1/docs/build-docs.bat" class="branch-name-link sg-text pjax" data-dropdown-button-type-title="Branch" data-name-escaped="simplification-1" data-name="simplification-1" data-url="/code/xrouter/git/nodes/simplification-1/docs/build-docs.bat">simplification-1</a></li><li class="sg"><a href="/code/xrouter/git/nodes/updatetoken-multilocks/docs/build-docs.bat" class="branch-name-link sg-text pjax" data-dropdown-button-type-title="Branch" data-name-escaped="updatetoken-multilocks" data-name="updatetoken-multilocks" data-url="/code/xrouter/git/nodes/updatetoken-multilocks/docs/build-docs.bat">updatetoken-multilocks</a></li><li class="sg"><a href="/code/xrouter/git/nodes/Version-2.0/docs/build-docs.bat" class="branch-name-link sg-text pjax" data-dropdown-button-type-title="Branch" data-name-escaped="Version-2.0" data-name="Version-2.0" data-url="/code/xrouter/git/nodes/Version-2.0/docs/build-docs.bat">Version-2.0</a></li>
          <div class="no-results">No results</div>
  ...
  <ul class="links-list mt-5 mr-5 float-right">
        ...
        <li class="action-links">
          <a href="/code/xrouter/git/node/blob/docs/build-docs.bat?raw=1&amp;rev=a572823b1d5ce125ae7da85e6413ca4b639827df">Raw</a>
          <em>|</em>
        </li>

      <li class="action-links"><a href="/code/xrouter/git/commits/master/docs/build-docs.bat" class="revision-log" rel="nofollow">Previous Versions</a></li>

        <em>|</em>
  <li>
    <a href="/code/xrouter/git/nodes/master/docs/build-docs.bat?_format=raw" class="download-icon" rel="nofollow">Download</a>
  </li>
  ...
  <div class="repo-breadcrumb">
    <a href="/code/xrouter/git/nodes/master" class="breadcrumb-path breadcrumb-separator pjax">/</a><a href="/code/xrouter/git/nodes/master/docs" class="breadcrumb-path pjax">docs</a><div class="breadcrumb-separator">/</div><div class="breadcrumb-path">build-docs.bat</div>
...
<a href="#ln6" class="inline" id="ln6">6</a></pre>
                  </td>
                  <td class="show-file-content">
                    <pre style="word-break:normal !important;word-wrap:normal !important; white-space:pre !important" class="prettyprint lang-bat">rem --- build HTML and LaTeX files ---
rem assumes installed Doxygen

doxygen DaemonNT.doxygen
doxygen SchemaTron.doxygen
doxygen XRouter.doxygen</pre>
                  </td>
                </tr>
              </tbody>
            </table>
